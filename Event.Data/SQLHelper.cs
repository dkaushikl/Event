namespace Event.Data
{
    ...
    public static class SqlHelper
    {
        ...
        /// <remarks>
        ///     e.g.:
        ///     DataSet ds = ExecuteDatasetAsync(connString, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="connectionString">A valid connection string for a SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        public static Task<DataSet> ExecuteDatasetAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteDatasetAsync(connection, commandType, commandText, null);
        ...
        public static Task<DataSet> ExecuteDatasetAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteDatasetAsync(transaction, commandType, commandText, null);
            ...
            string commandText)
        {
            ...
            DataSet dsResult;
            using (dsResult = new DataSet())
            {
                dsResult = await ExecuteDatasetAsync(connectionString, commandType, commandText, null);

                return dsResult != null && dsResult.Tables.Count > 0 ? dsResult.Tables[0] : new DataTable();
            }
        }
            ...
            params SqlParameter[] commandParameters)
        {
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                using (dsResult = new DataSet())
                {
                    dsResult = await ExecuteDatasetAsync(connection, commandType, commandText, commandParameters);
            ...
            params object[] parameterValues)
        {
            ...
            if (parameterValues != null && parameterValues.Length > 0)
            {
                ...
                dsResult = await ExecuteDatasetAsync(
                               connectionString,
            ...
            else
            {
                // Otherwise we can just call the SP without params
                dsResult = new DataSet();
                dsResult = await ExecuteDatasetAsync(connectionString, CommandType.StoredProcedure, spName);
            }
        ...
        public static async Task<DataTable> ExecuteDataTableAsync(
            ...
            string commandText)
        {
            var dsResult = await ExecuteDatasetAsync(connection, commandType, commandText, null);
            ...
            params object[] parameterValues)
        {
            ...
            if (parameterValues != null && parameterValues.Length > 0)
            {
                ...
                // Call the overload that takes an array of SqlParameters
                ds = await ExecuteDatasetAsync(connection, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                ds = new DataSet();
                ...
                // Otherwise we can just call the SP without params
                ds = await ExecuteDatasetAsync(connection, CommandType.StoredProcedure, spName);
            }
            ...
            string commandText)
        {
            ...
            // Pass through the call providing null for the set of SqlParameters
            ds = await ExecuteDatasetAsync(transaction, commandType, commandText, null);
            ...
            params object[] parameterValues)
        {
            ...
            if (parameterValues != null && parameterValues.Length > 0)
            {
                ...
                // Call the overload that takes an array of SqlParameters
                ds = await ExecuteDatasetAsync(transaction, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                ds = new DataSet();
                ...
                // Otherwise we can just call the SP without params
                ds = await ExecuteDatasetAsync(transaction, CommandType.StoredProcedure, spName);
            }
        ...
        public static Task<int> ExecuteNonQueryAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteNonQueryAsync(connectionString, commandType, commandText, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     int result = ExecuteNonQueryAsync(connString, CommandType.StoredProcedure, "PublishOrders", new
        ...
        public static Task<int> ExecuteNonQueryAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteNonQueryAsync(connection, commandType, commandText, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     int result = ExecuteNonQueryAsync(conn, CommandType.StoredProcedure, "PublishOrders", new SqlParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="connection">A valid SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        public static Task<int> ExecuteNonQueryAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteNonQueryAsync(transaction, commandType, commandText, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     int result = ExecuteNonQueryAsync(trans, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="transaction">A valid SqlTransaction</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        /// <remarks>
        ///     e.g.:
        ///     SqlDataReader dr = ExecuteReaderAsync(connString, CommandType.StoredProcedure, "GetOrders", new
        ///     SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">A valid connection string for a SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        public static Task<SqlDataReader> ExecuteReaderAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteReaderAsync(connection, commandType, commandText, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     SqlDataReader dr = ExecuteReaderAsync(conn, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="connection">A valid SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        public static Task<SqlDataReader> ExecuteReaderAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteReaderAsync(transaction, commandType, commandText, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     SqlDataReader dr = ExecuteReaderAsync(trans, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="transaction">A valid SqlTransaction</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        public static Task<object> ExecuteScalarAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteScalarAsync(connectionString, commandType, commandText, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     int orderCount = (int)ExecuteScalarAsync(connString, CommandType.StoredProcedure, "GetOrderCount", new
        ///     SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">A valid connection string for a SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        public static Task<object> ExecuteScalarAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteScalarAsync(connection, commandType, commandText, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     int orderCount = (int)ExecuteScalarAsync(conn, CommandType.StoredProcedure, "GetOrderCount", new
        ///     SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">A valid SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        public static Task<object> ExecuteScalarAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteScalarAsync(transaction, commandType, commandText, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     int orderCount = (int)ExecuteScalarAsync(trans, CommandType.StoredProcedure, "GetOrderCount", new
        ///     SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="transaction">A valid SqlTransaction</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        public static Task<XmlReader> ExecuteXmlReaderAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteXmlReaderAsync(connection, commandType, commandText, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     XmlReader r = ExecuteXmlReaderAsync(conn, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="connection">A valid SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        public static Task<XmlReader> ExecuteXmlReaderAsync(
            ...
            CommandType commandType,
            string commandText) =>
            ExecuteXmlReaderAsync(transaction, commandType, commandText, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     XmlReader r = ExecuteXmlReaderAsync(trans, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="transaction">A valid SqlTransaction</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        /// <remarks>
        ///     e.g.:
        ///     FillDatasetAsync(connString, CommandType.StoredProcedure, "GetOrders", ds, new string[] {"orders"}, new
        ///     SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">A valid connection string for a SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        public static Task FillDatasetAsync(
            ...
            DataSet dataSet,
            string[] tableNames) =>
            FillDatasetAsync(connection, commandType, commandText, dataSet, tableNames, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     FillDatasetAsync(conn, CommandType.StoredProcedure, "GetOrders", ds, new string[] {"orders"}, new
        ///     SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">A valid SqlConnection</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        public static Task FillDatasetAsync(
            ...
            string[] tableNames,
            params SqlParameter[] commandParameters) =>
            FillDatasetAsync(connection, null, commandType, commandText, dataSet, tableNames, commandParameters);
        ...
        public static Task FillDatasetAsync(
            ...
            DataSet dataSet,
            string[] tableNames) =>
            FillDatasetAsync(transaction, commandType, commandText, dataSet, tableNames, null);
        ...
        /// <remarks>
        ///     e.g.:
        ///     FillDatasetAsync(trans, CommandType.StoredProcedure, "GetOrders", ds, new string[] {"orders"}, new
        ///     SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="transaction">A valid SqlTransaction</param>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        ...
        /// <remarks>
        ///     e.g.:
        ///     FillDatasetAsync(conn, trans, CommandType.StoredProcedure, "GetOrders", ds, new string[] {"orders"}, new
        ///     SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">A valid SqlConnection</param>
        /// <param name="transaction">A valid SqlTransaction</param>
            ...
            params SqlParameter[] commandParameters)
        {
            ...
            var mustCloseConnection = await PrepareCommandAsync(
                                          command,
                                          connection,
                                          transaction,
                                          commandType,

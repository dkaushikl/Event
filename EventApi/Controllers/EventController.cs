namespace EventApi.Controllers
{
    ...
    public class EventController : BaseController
    {
        ...
        public async Task<IHttpActionResult> AddEvent(EventViewModel objEventViewModel)
        {
            ...
            if (this.Validation(objEventViewModel, out returnResult)) return returnResult;
        ...
        {
            var objResult =
                await this.eventRepository.GetAllEvent(pageIndex, pageSize, Convert.ToInt32(this.UserId), eventId);
